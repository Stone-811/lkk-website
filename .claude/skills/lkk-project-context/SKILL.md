...
**講師（2026-08-28 更新）**：業主兩份「講師自介」CSV 已匯入，練健康 11 位＋海外 1 位＋合作 3 位＝**15 位**。**石峻瑋已依業主指示刪除**（不在 CSV 名單、資料幾乎全空），連同那張戴全罩安全帽的錯誤照片 `liuchang.png` 一併移除，先前的紅字問題已解。仍有 3 位無去背照（李柏橋／吳禎明／阮玟文，是 500x500 白底 PNG 不是去背）；講師目錄另有 4 個沒人引用的中文檔名重複檔（周千媚／卓彥廷／盧昶碩／陳彥志，約 2.5MB），業主未表示是否刪除。
