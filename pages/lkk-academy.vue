...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: '練健康研習課程，整合 6,000+ 位學員與中高齡、特殊族群訓練實務，提供訓練營、中高齡訓練研習與鷹眼大師課程，涵蓋評估、訓練規劃、動作判讀與現場教學，培養真正能落地的教練專業。',
    },
  ],
})
...
const courses = [
  ...
  },
  {
    ...
    t: '中高齡訓練研習',
    img: '',
    quote: '「別將運動員的訓練課表，硬套在阿嬤身上。」',
    desc: [
      '隨著長照需求人數逼近 90 萬大關，慢性病、高齡、術後等特殊族群的訓練需求正快速增加。我們結合醫師、物理治療師與肌力教練的專業，打造為期四天、包含考核的精實研習，幫助你建立從評估、風險判斷到訓練執行的完整思路。',
    ],
    points: [
...
const whyUs = [
  { n: '01', t: '站在趨勢的浪頭上', d: '中高齡與特殊族群訓練已是現在進行式，市場需求持續增加，但真正具備評估、風險判斷與訓練整合能力的教練仍然不足。' },
  { n: '02', t: '數據說話，經驗為王', d: '課程基於 6,000+ 位個案的第一線實務經驗持續修正。我們不只告訴你原則，更整理出書本難以呈現的現場判斷與教學眉角。' },
  { n: '03', t: '推動健康老化的使命感', d: '我們不單是銷售課程，更希望培育能真正協助民眾重拾生活自主與尊嚴的專業教練。面對台灣高齡社會的挑戰，練健康以民眾健康為核心，透過客觀數據與嚴謹訓練系統，持續推動健康老化。' },
]
</script>
      ...
      <div class="container mx-auto px-4">
        <div class="grid lg:grid-cols-[.78fr_1.22fr] gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <span class="block font-serif text-6xl lg:text-7xl font-black text-orange leading-none tracking-tight mb-5">6,000+</span>
            ...
            <p class="text-ink/70 leading-relaxed">
              練健康自成立以來，累積服務超過 6,000 位學員，其中近 50% 為中高齡及特殊族群個案。這些第一線經驗，也是研習課程最重要的起點。
            </p>
          </div>
